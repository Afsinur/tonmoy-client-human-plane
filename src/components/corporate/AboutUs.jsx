  ...
  return (
    <>
      ...
      <p className="text-white text-xl">
        ...
        önemli projeyi sunmaktan onur duyuyoruz. Çalışmalarımızın odak
        noktasındaki Türkiye´nin ilk uçan insan icadı Cankuşu, Türk Savunma
        Sanayimizin hizmetine sunmayı hedefliyoruz. Özellikle engebeli arazilere
        sahip ve deprem kuşağında bulunan ülkemizde acil yardım ve kurtarma
        çalışmaları için kullanımı öngörülen Cankuşu, aynı zamanda sağlık
        sektöründe de kullanabilmektedir.
      </p>
    </>
  );
}
